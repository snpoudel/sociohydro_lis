...
#these are the census tracts with missing values on housing information
  ...
  for (ct in 1:length(fips$V1))  #436
    {
        #Read in index
        ...
        write.table(Coeff_SH_mat,paste("C:/SANDEEP/SocioHydro_Model/Results/SH_Parameters.csv"),sep=",")
        ...
        write.table(Results_SH_mat,paste("C:/SANDEEP/SocioHydro_Model/Results/SH_Results.csv"),sep=",")
        ...
        write.table(RMSE_best_mat,paste("C:/SANDEEP/SocioHydro_Model/Results/SH_RMSE.csv"),sep=",")
